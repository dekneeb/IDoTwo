...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main_app', '0021_alter_item_photos'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='static/message_photos')),
                ...
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='main_app.threadmodel')),
            ],
        ),
    ]
